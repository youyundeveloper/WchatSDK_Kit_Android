package com.ioyouyun.ui.chat.lib;

import com.ioyouyun.ui_chat_lib.R;

public class ResString {
	
	public static int getString_wm_receive_a_new_msg(){
		return R.string.wm_receive_a_new_msg;
	}
	...
	public static int getString_wm_conversatin_title_offline(){
		return R.string.wm_conversatin_title_offline;
	}
